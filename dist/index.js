...
module.exports = function (input) {
  if (!(input instanceof Uint8Array || Buffer.isBuffer(input))) {
    throw new TypeError("Expected the `input` argument to be of type `Uint8Array` or `Buffer`, got `".concat(_typeof(input), "`"));
  }
...
Object.defineProperty(module.exports, 'minimumBytes', {
  value: 4100
});